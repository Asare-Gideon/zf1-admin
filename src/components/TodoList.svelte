<div
	class="grid w-full grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white"
>
	...
	<div class="md:col-span-2 xl:col-span-1">
		<div class="rounded bg-gray-200 dark:bg-gray-800 p-3">
			...
			<div class="text-sm text-black dark:text-gray-50 mt-2">
				...
				<input
					class="mt-3 dark:bg-slate-700 rounded-md dark:text-slate-50 p-3 w-full"
